...
def password_please() -> str:
    ...
    the_answer = str("Emily Tan")
    return the_answer


def list_please() -> list:
    """Returns a list, you can put anything in the list."""
    the_answer = list(["donuts", "bananas", "cake"])
    return the_answer
...
def dictionary_please() -> dict:
    ...
    a_dictionary = {"fruit": "apples", "dessert": "cake", "sport": "soccer"}
    return a_dictionary
...
def make_filler_text_dictionary() -> Dict:
    ...
    for word_length in range(3, 8):
        words_list = []
        for _ in range(4):  # Get 4 words for each word length
